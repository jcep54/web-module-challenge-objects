...
console.log(burger.discount('public'), 'burger task')
...
function addReview(array, newName, newRating, newFeedback){
  array.push({name: newName, rating: newRating, feedback: newFeedback})
  return array;
}
console.log(addReview(testArray,'Jimbo', 4, 'It was pretty good'))
